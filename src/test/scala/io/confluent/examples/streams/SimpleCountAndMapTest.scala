...
/**
  ...
  */
class SimpleCountAndMapTest extends AssertionsForJUnit {
  ...
  def shouldCountWords() {
   ...
   // val textLines: KStream[Array[Byte], String] = builder.stream[Array[Byte], String](inputTopic)
    ...
    val textLines: KStream[String, String] = builder.stream[Array[Byte], String](inputTopic)
    ...
    try {
      ...
      //
      val outputSerialized = output.readKeyValuesToMap()
      assertThat(outputSerialized).isEqualTo(expectedWordCounts.asJava)
    } finally {
